...
import com.alexzh.company.contacts.employees.EmployeesRxActivity
import io.reactivex.disposables.CompositeDisposable
import kotlinx.android.synthetic.main.activity_teams.*

class TeamsRxActivity : AppCompatActivity(), SwipeRefreshLayout.OnRefreshListener {
    private lateinit var viewModel: TeamsViewModel
    private val disposable = CompositeDisposable()
    private val teamsAdapter: TeamsAdapter by lazy {
        TeamsAdapter(itemClick = { EmployeesRxActivity.start(this, it)})
    }
